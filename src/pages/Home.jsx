    ...
    <>
      ...
      <section className="recent-activities">
        ...
        {recentActivities.length > 0 ? (
            ...
            {recentActivities.map((activity, index) => (
              <div
                ...
                className={`activity-card ${
                  activity.type === "oil" ? "oil-disposal" : "qr-code"
                }`}
              >
          ...
          <div className="empty-state">
            ...
            <Link to="/scan" className="eco-button">
              Iniciar atividade
            </Link>
          </div>
        )}
            ...
            {topUsers.map((user, index) => (
              ...
              >
                ...
                <div className="rank-user-name">
                  {user.nome}
                  {user.isCurrentUser && (
                    <span className="user-indicator"> (Você)</span>
                  )}
                </div>
      ...
      <section className="local-offers">
          ...
          <div className="offer-card">
            ...
            <div className="offer-content">
              ...
              <p className="offer-description">
                Troque 250 pontos por 15% de desconto na próxima compra
              </p>
        ...
        <div className="see-more-container">
          <Link to="/rewards" className="see-more-button">
            Ver mais
          </Link>
        </div>
      </section>
